...
function hideNav(event) {
	document.querySelector('#navShow').checked = false;
	console.log("Yes");
}

var headerPrevScrollpos = window.scrollY;
function toggleHeader() {
	var currentScrollPos = window.scrollY;
	if (headerPrevScrollpos > currentScrollPos) {
		document.querySelector('.header').classList.remove('header_hidden');
	} else {
		document.querySelector('.header').classList.add('header_hidden');
	}
	headerPrevScrollpos = currentScrollPos;
} 